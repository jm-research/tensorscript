#ifndef TENSORSCRIPT_IR_BUILDER_H
#define TENSORSCRIPT_IR_BUILDER_H
...
class builder {
 ...
 public:
  ...
  value* create_cond_br(value* cond, basic_block* if_dest,
  ...
  phi_node* create_phi(type* ty, unsigned num_reserved,
                       const std::string& name = "");
  // Binary instructions
  value* create_insert_nuwnswb_binop(binary_op_t op, value* lhs, value* rhs,
  ...
  value* create_mul(value* lhs, value* rhs, const std::string& name = "",
                    bool has_nuw = false, bool has_nsw = false);
  ...
  value* create_sub(value* lhs, value* rhs, const std::string& name = "",
                    bool has_nuw = false, bool has_nsw = false);
  value* create_shl(value* lhs, value* rhs, const std::string& name = "",
                    bool has_nuw = false, bool has_nsw = false);
  ...
  value* create_masked_store(value* ptr, value* val, value* mask,
                             const std::string& name = "");
  // Tile instruction
  value* create_splat(value* arg, const type::tile_shapes_t& shapes,
                      const std::string& name = "");
  value* create_reshape(value* arg, const type::tile_shapes_t& shapes,
                        const std::string& name = "");
  value* create_broadcast(value* arg, const type::tile_shapes_t& shapes,
                          const std::string& name = "");
  ...
  value* create_atomic_exch(value* ptr, value* val,
                            const std::string& name = "");
  value* create_atomic_add(value* ptr, value* val,
                           const std::string& name = "");
...
#endif  // TENSORSCRIPT_IR_BUILDER_H