#ifndef TENSORSCRIPT_DRIVER_DISPATCH_H
#define TENSORSCRIPT_DRIVER_DISPATCH_H
...
// CUDA Backend
#include "tensorscript/external/cl/cl.h"
#include "tensorscript/external/cl/cl_ext.h"
#include "tensorscript/external/cuda/cuda.h"
#include "tensorscript/external/cuda/nvml.h"
...
class dispatch {
 protected:
  ...
  static typename return_type<FunPtrT>::type f_impl(void*& lib_h, FunPtrT,
                                                    void*& cache,
                                                    const char* name,
                                                    Args... args) {
    initializer();
 ...
 public:
  ...
  static cl_int clGetCommandQueueInfo(cl_command_queue, cl_command_queue_info,
                                      size_t, void*, size_t*);
  ...
  static cl_context clCreateContext(
  ...
  static cl_int clGetContextInfo(cl_context, cl_context_info, size_t, void*,
                                 size_t*);
  static cl_int clGetDeviceInfo(cl_device_id, cl_device_info, size_t, void*,
                                size_t*);
  static cl_int clReleaseCommandQueue(cl_command_queue);
  static cl_int clGetPlatformIDs(cl_uint, cl_platform_id*, cl_uint*);
  static cl_int clGetPlatformInfo(cl_platform_id, cl_platform_info, size_t,
                                  void*, size_t*);
  static cl_int clGetEventProfilingInfo(cl_event, cl_profiling_info, size_t,
                                        void*, size_t*);
  ...
  static cl_int clGetProgramInfo(cl_program, cl_program_info, size_t, void*,
                                 size_t*);
  static cl_int clGetKernelInfo(cl_kernel, cl_kernel_info, size_t, void*,
                                size_t*);
  ...
  static cl_int clCreateKernelsInProgram(cl_program, cl_uint, cl_kernel*,
                                         cl_uint*);
  static cl_mem clCreateBuffer(cl_context, cl_mem_flags, size_t, void*,
                               cl_int*);
  ...
  static bool writeSpirv(llvm::Module* M, std::ostream& OS,
                         std::string& ErrMsg);
...
#endif  // TENSORSCRIPT_DRIVER_DISPATCH_H