#ifndef TENSORSCRIPT_DRIVER_ERROR_H
#define TENSORSCRIPT_DRIVER_ERROR_H
...
#define ISAAC_CREATE_NVRTC_EXCEPTION(name, msg)                       \
  class name : public std::exception {                                \
   public:                                                            \
    const char* what() const throw() { return "NVRTC: Error- " msg; } \
  }

ISAAC_CREATE_NVRTC_EXCEPTION(out_of_memory, "out of memory");
ISAAC_CREATE_NVRTC_EXCEPTION(program_creation_failure,
...
ISAAC_CREATE_NVRTC_EXCEPTION(builtin_operation_failure,
...
#define ISAAC_CREATE_CUDA_EXCEPTION(name, msg)                       \
  class name : public base {                                         \
   public:                                                           \
    const char* what() const throw() { return "CUDA: Error- " msg; } \
  }
...
ISAAC_CREATE_CUDA_EXCEPTION(profiler_not_initialized,
                            "profiler not initialized");
ISAAC_CREATE_CUDA_EXCEPTION(profiler_already_started,
                            "profiler already started");
ISAAC_CREATE_CUDA_EXCEPTION(profiler_already_stopped,
...
ISAAC_CREATE_CUDA_EXCEPTION(invalid_graphics_context,
...
ISAAC_CREATE_CUDA_EXCEPTION(shared_object_symbol_not_found,
                            "shared object symbol not found");
ISAAC_CREATE_CUDA_EXCEPTION(shared_object_init_failed,
...
ISAAC_CREATE_CUDA_EXCEPTION(launch_incompatible_texturing,
                            "launch incompatible texturing");
ISAAC_CREATE_CUDA_EXCEPTION(peer_access_already_enabled,
...
ISAAC_CREATE_CUDA_EXCEPTION(host_memory_already_registered,
                            "host memory already registered");
ISAAC_CREATE_CUDA_EXCEPTION(host_memory_not_registered,
...
#define ISAAC_CREATE_CUBLAS_EXCEPTION(name, msg)                       \
  class name : public base {                                           \
   public:                                                             \
    const char* what() const throw() { return "CUBLAS: Error- " msg; } \
  }
...
namespace cudnn {
#define ISAAC_CREATE_CUDNN_EXCEPTION(name, msg)                       \
  class name : public std::exception {                                \
   public:                                                            \
    const char* what() const throw() { return "CUDNN: Error- " msg; } \
  }
...
ISAAC_CREATE_CUDNN_EXCEPTION(runtime_prerequisite_missing,
...
#define ISAAC_CREATE_CL_EXCEPTION(name, msg)                           \
  class name : public base {                                           \
   public:                                                             \
    const char* what() const throw() { return "OpenCL: Error- " msg; } \
  }
...
ISAAC_CREATE_CL_EXCEPTION(mem_object_allocation_failure,
...
ISAAC_CREATE_CL_EXCEPTION(profiling_info_not_available,
...
ISAAC_CREATE_CL_EXCEPTION(image_format_not_supported,
...
ISAAC_CREATE_CL_EXCEPTION(invalid_image_format_descriptor,
...
ISAAC_CREATE_CL_EXCEPTION(invalid_program_executable,
                          "invalid program executable");
ISAAC_CREATE_CL_EXCEPTION(invalid_kernel_name, "invalid kernel name");
ISAAC_CREATE_CL_EXCEPTION(invalid_kernel_definition,
...
#endif  // TENSORSCRIPT_DRIVER_ERROR_H
