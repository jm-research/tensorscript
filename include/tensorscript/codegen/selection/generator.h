#ifndef TENSORSCRIPT_CODEGEN_SELECTION_GENERATOR_H
#define TENSORSCRIPT_CODEGEN_SELECTION_GENERATOR_H
...
class generator : public ir::visitor, public analysis::layout_visitor {
 private:
  ...
  void visit_hmma_dot(ir::dot_inst*, shared_tile* TA, shared_tile* TB,
                      distributed_tile* TD, unsigned NK);
  void visit_scanline_dot(ir::dot_inst*, shared_tile* TA, shared_tile* TB,
                          distributed_tile* TD, unsigned NK, Type* c_ty,
                          Function* f_mul_add);
  void visit_outer_dot(ir::dot_inst*, distributed_tile* TA,
                       distributed_tile* TB, distributed_tile* TD, unsigned NK,
 ...
 public:
  generator(analysis::axes* a_axes, analysis::layouts* layouts,
...
#endif  // TENSORSCRIPT_CODEGEN_SELECTION_GENERATOR_H
