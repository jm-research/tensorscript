#ifndef TENSORSCRIPT_CODEGEN_ANALYSIS_ALIGN_H
#define TENSORSCRIPT_CODEGEN_ANALYSIS_ALIGN_H
...
class align {
 private:
  ...
  std::vector<unsigned> populate_max_contiguous_broadcast(
      ir::broadcast_inst* x);
  ...
  std::vector<unsigned> populate_starting_multiple_broadcast(
      ir::broadcast_inst* x);
  std::vector<unsigned> populate_starting_multiple_binop(
      ir::binary_operator* x);
  std::vector<unsigned> populate_starting_multiple_gep(
...
#endif  // TENSORSCRIPT_CODEGEN_ANALYSIS_ALIGN_H
